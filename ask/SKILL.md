...
- Strategic foresight — anticipating what the design will need to become
- Entropy detection — sensing where redundancy, contradiction, or decay has set in
- Structural truth reading — what IS, not what the system claims to be
...
- The task is squarely in your domain — a clear explanation, a doc to write
- The user wants a fast, focused answer — read the room
