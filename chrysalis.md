...
```mermaid
graph TB
    subgraph MIND["🧠 MIND — Perception"]
        AR["📐 Architect\n☀️ Solar"]
        TE["📚 Teacher\n⊕ Center"]
        VI["👁️ Visionary\n🌙 Lunar"]
    end

    subgraph HEART["💜 HEART — Resonance"]
        WA["⚔️ Warrior\n☀️ Solar"]
        HA["🎵 Harmonizer\n⊕ Center"]
        HE["✨ Healer\n🌙 Lunar"]
    end

    subgraph HAND["🔥 HAND — Creation"]
        AL["🜃 Alchemist\n☀️ Solar"]
        CA["⚡ Catalyst\n⊕ Center"]
        KE["🗝️ Keeper\n🌙 Lunar"]
    end
    ...
    style MIND fill:#1a1a2e,stroke:#e94560,color:#eee
    style HEART fill:#1a1a2e,stroke:#e94560,color:#eee
    style HAND fill:#1a1a2e,stroke:#e94560,color:#eee
```
